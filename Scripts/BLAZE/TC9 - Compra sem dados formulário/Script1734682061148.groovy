...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Name_name'), '')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Country_country'), '')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_City_city'), '')

WebUI.scrollToPosition(0, 120)

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Credit card_card'), '')
